...
import servicios.Servicio_CuadroLote;
...
public class Vista_ABM_CuadroLote implements Vista {

    // el servicio con el que se va a comunicar la vista
    private final Servicio_CuadroLote servicio;
    ...
    public Vista_ABM_CuadroLote(Servicio_CuadroLote servicio) {
    ...
    public Parent obtenerVista() {
        ...
        var etiquetaIdEmpleado = new Label("--");
