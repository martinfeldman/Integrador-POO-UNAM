...
import servicios.*;
import vistas.VistaDepartamentos;
import vistas.Vista_ABM_Empleado;
...
public class App extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        var servicio_empleado = new Servicio_empleado(new Repositorio(emf));

        // creamos vistas, las cuales necesitan un servicio
        vistaEmpleados = new Vista_ABM_Empleado(servicio_empleado);
